...
printRepresentations(
    "person in python-dictionary form",
    person_dict,
    "person in json form",
...
printRepresentations(
    "person in proto form", person, "person in binary form", person.SerializeToString()
)
...
print(
    f"Took {person_bin_file_size} bytes to store serialized data(using protobuf) in binary format\n"
)
...
persons_list = [
    ...
    {"firstName": "John", "lastName": "Doe", "age": 26, "email": "johndoe@mail.com"},
    {
        "firstName": "Bruce",
        "lastName": "Wayne",
        "age": 27,
...
printRepresentations(
    "persons in python-list form",
    persons_list,
    "persons in JSON form",
    json.dumps(persons_list),
)
...
printRepresentations(
    "persons in proto form",
    persons,
    "persons in binary form",
    persons.SerializeToString(),
)
